...
import { PulseCompletionProvider } from './providers/completionProvider';
import { PulseHoverProvider } from './providers/hoverProvider';
import { PulseDiagnosticsProvider } from './providers/diagnosticsProvider';
import { PulseDefinitionProvider } from './providers/definitionProvider';
import { PulseFormattingProvider } from './providers/formattingProvider';
import { PulseDocumentSemanticTokensProvider } from './providers/semanticTokensProvider';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  // Register completion provider with enhanced triggers
  ...
  // Register semantic tokens provider for better syntax highlighting
  const legend = new vscode.SemanticTokensLegend(
    ['variable', 'function', 'property', 'parameter', 'class'],
  ...
  context.subscriptions.push(
    vscode.languages.registerDocumentSemanticTokensProvider(
      PULSE_MODE,
      new PulseDocumentSemanticTokensProvider(),
      legend,
    ),
  );
...
export function deactivate() {
  ...
  console.log('⚡ Pulse Framework extension deactivated');
}
