...
export default function App(props) {
  ...
  createEffect(() => {
    const el = walk(container, [0]);
    if (el) el.setAttribute('class', state.selected === row.id ? "danger" : "");
  });
